...
These drills are for local or planned non-production environments only.
...
Run these against local or planned non-production environments only. Do not run outage drills against real production.
