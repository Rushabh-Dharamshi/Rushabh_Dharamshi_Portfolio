...
Budget Tracker is a full-stack personal finance application for recording expenses, monitoring budget performance, generating reports, and surfacing predictive insights from monthly spending data. The system uses a Flask backend for business logic and APIs, PostgreSQL for persistence, and a Next.js frontend for the user experience.
