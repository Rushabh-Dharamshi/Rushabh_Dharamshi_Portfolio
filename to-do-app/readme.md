...
### Front-end
- ⚛️ **React** — Build dynamic and responsive UI components.
...
- 🖥️ The **React frontend** acts as the client, sending HTTP requests to the backend API.
- 🔄 The **Express backend** processes requests, interacts with the MySQL database, and returns JSON responses.
- ⚙️ This separation ensures scalability, clean code organization, and easy maintenance.
